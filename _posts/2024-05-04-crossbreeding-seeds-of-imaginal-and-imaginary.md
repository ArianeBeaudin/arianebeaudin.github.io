---
layout: post
title: crossbreeding seeds of the imaginal and the imaginary
description: musing on metaphors, sowing some seeds on the imaginal, the imaginary, hyperstitions, languages, etc.
---


I recently started a new substack called [*A Reader's Compost Heap*](https://areaderscompostheap.substack.com/), where I honor what I read with ''sensemaking'' creative essays. I sat down this morning to write a new entry for it when I realized my musings weren't suited for the compost heap (yet), it was more like seeds that needed to be planted here. 
...
- The imaginary vs the imaginal: the first is fantasy, the second is ''objective psyche'', another realm in and on itself, where we can namely communicate with other real entities (like plants)
	...
	+ but also the words of Benjamin Labatut: 'Writing should give you access to the world, but it should also darken it for you so it becomes mysterious again.'' His whole interviews with the Louisana Channel are just pure gold ([1](https://youtu.be/E-OFnHwuTBg?si=4ze6P2oSwFY0WRYH))([2](https://youtu.be/ohsQ3WtdWoM?si=S6HhHjGclQMZ5jVA)).
	+ and let's add the whole concept of Hyperstition, which I have discussed in my [last digital garden entry](https://www.ravirer.com/2024/03/16/accelerationism-diversity-of-tactics/).
